...
for seed in seeds:
    ...
    reward_over_episodes = train_agent(env, agent, policy_optim, value_optim, 
...
df.to_csv("results/reinforce_with_baseline.csv")
...
plt.savefig("figures/reinforce_with_baseline.png")
